...
REPO_API_URL="https://api.github.com/repos/iadvize/mobile-reactnative-sdk-conversation-library"
...
sed -i '' "s/\"@iadvize-oss\/iadvize-react-native-sdk\": \"^\(.*\)\",/\"@iadvize-oss\/iadvize-react-native-sdk\": \"^${sdk_version}\",/" example/package.json
